...
@section('content')
    ...
    <div class="fun"><h3 class="left"><a href="javascript:void(0);" onclick="fastH(this,'main')"
                                         url="{{ route('appointment-tracks.create', ['appointment_id' => $appointment->id]) }}"><span
    ...
    <div id="box" class="box">
                ...
                <tr class="t1">
                    <td>
                        <center><a href="javascript:void(0);" onclick="fastH(this,'main')"
                                   url="track.asp?act=add&amp;s=1&amp;aid=2&amp;id=1&amp;m=res" title="记录编辑">{{ $track->created_at->format('Y-m-d H:i') }}</a></center>
                    </td>
                    <td>{{ $track->content }}&nbsp;</td>
                    <td>
                    ...
                    <td>
                        <center><a href="javascript:void(0);" id="del1" style="color:red"
                                   onclick="if(confirm('确定删除吗？\n\n该操作不可恢复')){fast('track.asp?act=del&amp;id=1','del1');}"><span
        ...
        <input type="hidden" name="this_url" id="this_url" value="/track.asp?aid=1&amp;m=res"></div>
@endsection